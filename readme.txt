# Sistema de Ajuste de Dificuldade com IA
...
- Registro de respostas em um arquivo CSV
- IA que treina com base no histórico de acertos/erros
...
```bash
git clone https://github.com/sh1inx/logs_pipeline.git
